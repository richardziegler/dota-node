...
console.log('   ___  ____  _________     ___  ___  ____  __________   ____\n' +
...
axios.get(`http://api.steampowered.com/ISteamUser/ResolveVanityURL/v0001/?key=${steamAPIKey}&vanityurl=${steamUsername}`)
